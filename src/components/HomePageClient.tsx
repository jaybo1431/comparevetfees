...
import { searchPractices } from "@/data/practices";
...
export default function HomePageClient({ practices }: HomePageClientProps) {
    ...
    <div>
      ...
      <section className="bg-blue-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
          ...
          <Link
            href="/claim"
            className="bg-white text-blue-700 font-medium px-6 py-3 rounded-lg hover:bg-blue-50 transition inline-flex items-center gap-2"
          >
